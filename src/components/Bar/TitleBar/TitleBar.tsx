...
export function TitleBar() {
  ...
  const name =
    info.info.value.name === "season:blank"
      ? "Без названия"
          ...
          <div className={styles.container}>
            <div className={styles.params}>
              ...
              <Param
                label="Размер"
                value={
                  place.image.value.size.x + "x" + place.image.value.size.y
                }
              />
            ...
            <div className={styles.projectInfo}>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://thefluffnetwork.ru">
                <p>
                  Наш дискорд сервер <Icon icon="discord" />
                </p>
              </a>
              <p>
                Основано на проекте{" "}
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://github.com/pixelate-it">
                  Pixelate It!
                </a>
              </p>
            </div>
